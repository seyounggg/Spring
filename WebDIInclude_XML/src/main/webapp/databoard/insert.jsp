...
<body>
  <div class="row row1">
    ...
    <table class="table">
      ...
      <tr>
        <th width=15% class="text-right danger">제목</th>
        <td width=85%>
          <input type=text name=subject size=50 class="input-sm">
        </td>
      </tr>
      <tr>
        <th width=15% class="text-right danger">내용</th>
        <td width=85%>
          <textarea rows="10" cols="50" name="content"></textarea>
        </td>
      </tr>
      <tr>
        <th width=15% class="text-right danger">첨부파일</th>
        <td width=85%>
          <table class="table">
            <tr>
              <td class="text-right">
                <input type=button value="추가" class="btn btn-xs btn-info" id="addBtn">
                <input type=button value="취소" class="btn btn-xs btn-info" id="removeBtn">
              </td>
            </tr>
          </table>
      ...
      <tr>
        <th width=15% class="text-right danger">비밀번호</th>
        <td width=85%>
