...
public class ReplyRestController {
	...
	// insert / delete / update 시 사용해야하는 공통 method!!!
	...
	@GetMapping(value="food/reply_list_vue.do", produces="text/palin;charset=utf-8")
	public String reply_list(int fno) {
		
		return reply_list_data(fno);
	}
	
	@PostMapping(value="food/reply_insert_vue.do", produces="text/palin;charset=utf-8")
	...
	@GetMapping(value="food/reply_delete_vue.do", produces="text/palin;charset=utf-8")
