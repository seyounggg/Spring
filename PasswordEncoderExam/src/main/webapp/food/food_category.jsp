	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="text-center">
				...
				<button class="btn btn-sm btn-warning" @click="categoryGetData(2)">지역별 맛집 리스트</button>
		...
		<div class="row">
		    ...
		    <div class="thumbnail">
		        ...
		        <div class="caption">
		          <p style="font-size: 9pt;text-align: center">{{vo.title}}</p>
		        </div>
		    </div>
		    </div>
