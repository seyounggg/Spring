...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    <div id="logo" class="fl_left">
      <h1><a href="../main/main.do">Tilse & Session</a></h1>
    </div>
    <div class="fl_right">
      <ul class="inline">
        <li><i class="fa fa-phone"></i>ID:<input type="text" name="id" size=10></li>
        <li><i class="fa fa-envelope-o"></i>pwd:<input type=password name="pwd" size=10></li>
      </ul>
    </div>
  </header>
</div>
  ...
  <nav id="mainav" class="clear">
    <ul class="clear">
      ...
      <li><a class="drop" href="#">맛집</a>
        <ul>
          <li><a href="../member/join.do">맛집추천</a></li>
          <li><a href="pages/full-width.html">맛집찾기</a></li>
        </ul>
      </li>
      ...
      <li><a class="drop" href="#">스토어</a>
        <ul>
          <li><a href="pages/gallery.html">상품목록</a></li>
