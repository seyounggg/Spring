  ...
  <div class="wrapper row3">
    <main class="container clear">
      ...
      <form method="post" action="../member/join_ok.do" name="joinFrm" id="joinFrm">
        <table class="table">
          <tr>
            <th class="text-right" width=10%>아이디</th>
          ...
          <tr>
            ...
            <td width=90% class="inline">
              ...
              <input type=button value="우편번호 검색" class="btn btn-sm btn-info" id=postBtn>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan=2 class="text-center">
              <input type=button value="회원가입" class="btn btn-sm btn-success" id="joinBtn">
