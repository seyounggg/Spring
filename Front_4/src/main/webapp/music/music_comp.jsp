	...
	<div class="container">
		...
		<div class="row">
			<div class="text-center">
				...
				<b-button variant="outline-danger" @click="musicGetData(7)">CLASIC</b-button>
			</div>
		</div>
...
// component => Vue통신
	...
	Vue.component('music',{
		...
		template:'<table class="table">'
							...
							+'<b-button id="show-btn" variant="outline-success" @click="showMovie(vo.mno,true)" style="width: 80px; padding: 5px 10px;">동영상</b-button>'
							+'</td>'
							+'</tr>'
							+'</tbody>'
							+'</table>',
